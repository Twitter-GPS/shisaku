...
tweetbutton = '<input type="button" value="現在地をツイートする" onclick="maketweet">'
...
function tweetbutton(){
  '<A href="https://twitter.com/intent/tweet?text=ここにいます+http://maps.google.co.jp/maps?f=q%26hl=ja%26q='+ido+','+keido+'%26ie=UTF8%26ll='+ido+','+keido+'%26z=14" target="_blank">ツイートする</A>'
}
